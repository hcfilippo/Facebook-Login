...
@property (weak, nonatomic) IBOutlet FBProfilePictureView *myprofilePictureView;
...
- (void)loginViewFetchedUserInfo:(FBLoginView *)loginView
    ...
    self.myprofilePictureView.profileID = user.objectID;
    self.mynameLabel.text = user.name;
    
}

// Implement the loginViewShowingLoggedInUser: delegate method to modify your app's UI for a logged-in user experience
- (void)loginViewShowingLoggedInUser:(FBLoginView *)loginView {
    self.mystatusLabel.text = @"You're logged in as";
}

// Implement the loginViewShowingLoggedOutUser: delegate method to modify your app's UI for a logged-out user experience
- (void)loginViewShowingLoggedOutUser:(FBLoginView *)loginView {
    self.myprofilePictureView.profileID = nil;
    self.mynameLabel.text = @"";
    self.mystatusLabel.text= @"You're not logged in!";
}
